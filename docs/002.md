...
![](img/2ee0fbe5392f559c22907ec7d07e123c.png)
...
![Open-domain Extractive QA pipeline](img/9291d1e5e1c7d357c8cf73686ba5226d.png)
...
![DPR Top-k accuracy performance when compared to BM25](img/28eb9ed1cef8d7b5126273b34b3645e3.png)
...
![Similarity Calculation](img/86af95678c6f7dded7771878eac04ffd.png)

Similarity Calculation

这里， *q* 、 *p* 、 *Eq* 、 *Ep* 分别对应问题文本、段落文本、输出问题表征的 [BERT](https://arxiv.org/abs/1810.04805) 模型、输出段落表征的 BERT 模型。作者使用768 维度表示的 **CLS** 令牌作为输入文本块的最终表示。
...
![](img/69507bed63d714c468a854866df42333.png)
