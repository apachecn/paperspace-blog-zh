...
<video src="https://blog.paperspace.com/content/media/2022/04/final.mp4" poster="https://img.spacergif.org/v1/1325x720/0a/spacer.png" width="1325" height="720" playsinline="" preload="metadata" style="background: transparent url('https://blog.paperspace.com/conteimg/2022/04/media-thumbnail-ember2573.jpg') 50% 50% / cover no-repeat;">0:00/<input type="range" class="kg-video-seek-slider" max="100" value="0"><button class="kg-video-playback-rate">1×</button><input type="range" class="kg-video-volume-slider" max="100" value="100"></video>
...
<video src="https://blog.paperspace.com/content/media/2022/04/fixed.mp4" poster="https://img.spacergif.org/v1/1294x720/0a/spacer.png" width="1294" height="720" playsinline="" preload="metadata" style="background: transparent url('https://blog.paperspace.com/conteimg/2022/04/media-thumbnail-ember2557.jpg') 50% 50% / cover no-repeat;">0:00/<input type="range" class="kg-video-seek-slider" max="100" value="0"><button class="kg-video-playback-rate">1×</button><input type="range" class="kg-video-volume-slider" max="100" value="100"></video>
...
<video src="https://blog.paperspace.com/content/media/2022/04/plotly.mp4" poster="https://img.spacergif.org/v1/1325x720/0a/spacer.png" width="1325" height="720" playsinline="" preload="metadata" style="background: transparent url('https://blog.paperspace.com/conteimg/2022/04/media-thumbnail-ember2585.jpg') 50% 50% / cover no-repeat;">0:00/<input type="range" class="kg-video-seek-slider" max="100" value="0"><button class="kg-video-playback-rate">1×</button><input type="range" class="kg-video-volume-slider" max="100" value="100"></video>
...
<video src="https://blog.paperspace.com/content/media/2022/04/combinemd.mp4" poster="https://img.spacergif.org/v1/1325x720/0a/spacer.png" width="1325" height="720" playsinline="" preload="metadata" style="background: transparent url('https://blog.paperspace.com/conteimg/2022/04/media-thumbnail-ember2601.jpg') 50% 50% / cover no-repeat;">0:00/<input type="range" class="kg-video-seek-slider" max="100" value="0"><button class="kg-video-playback-rate">1×</button><input type="range" class="kg-video-volume-slider" max="100" value="100"></video>
...
<video src="https://blog.paperspace.com/content/media/2022/04/kernel.mp4" poster="https://img.spacergif.org/v1/1325x720/0a/spacer.png" width="1325" height="720" playsinline="" preload="metadata" style="background: transparent url('https://blog.paperspace.com/conteimg/2022/04/media-thumbnail-ember2651.jpg') 50% 50% / cover no-repeat;">0:00/<input type="range" class="kg-video-seek-slider" max="100" value="0"><button class="kg-video-playback-rate">1×</button><input type="range" class="kg-video-volume-slider" max="100" value="100"></video>
...
<video src="https://blog.paperspace.com/content/media/2022/04/new-terminal.mp4" poster="https://img.spacergif.org/v1/1325x720/0a/spacer.png" width="1325" height="720" playsinline="" preload="metadata" style="background: transparent url('https://blog.paperspace.com/conteimg/2022/04/media-thumbnail-ember2911.jpg') 50% 50% / cover no-repeat;">0:00/<input type="range" class="kg-video-seek-slider" max="100" value="0"><button class="kg-video-playback-rate">1×</button><input type="range" class="kg-video-volume-slider" max="100" value="100"></video>
